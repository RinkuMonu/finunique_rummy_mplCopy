                        ...
                        <div className="collapse navbar-collapse" id="navbarNav">
                            <ul className="navbar-nav mx-auto gap-3">
                                ...
                                <li className="nav-item dropdown">
                                    <DropdownButton
                                        id="game-dropdown"
                                        title={<span className="fw-bold text-dark">{t("Games")}</span>}
                                        variant="light"
                                    >
                                        {gameList.map((game, index) => (
                                            <Dropdown.Item key={index} as={Link} to={game.path} className="text-dark">
                                ...
                                <li className="nav-item">
                                    <Link to="/faq" className="nav-link">{t("FAQs")}</Link>
                                </li>
                                ...
                                <li className="nav-item d-flex gap-3 align-items-center">
                                    ...
                                    <div className="position-relative">
                                        ...
                                        {showDropdown && (
                                            ...
                                            >
                                                {["en", "hi", "gu", "mr", "bn", "ta", "te", "kn"].map((lang, index) => (
