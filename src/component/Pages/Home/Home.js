            ...
            <div className='container'>
                ...
                <div className='container'>
                    <div className='row my-4'>
                        <div className='col-md-4'>
                            <div
                                className="d-flex flex-column justify-content-between mb-3 rounded-3 border p-4 mainreview"
                                style={{
                            ...
                            >
                                <div className="d-flex flex-column gap-3">
                                    <div className="d-flex flex-column flex-sm-row align-items-center gap-3" style={{}}>
                                        <img
                                            alt="Picture of real player Rohit"
                                            loading="lazy"
                                            width="80"
                                            height="80"
                                        ...
                                        />
                                        <div>
                                            <p className="fw-bold text-uppercase italic" style={{ color: "var(--para-text-1)", fontSize: "20px" }}>ROHIT</p>
